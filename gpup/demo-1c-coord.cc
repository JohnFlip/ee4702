...
World::init()
{
  ...
  /*
  //CARD0
  card0 = new Card();   // Instantiate card.
  cards += card0;       // Put card in list of cards to render.
  
  // Set upper left from a constant coordinate (pos1).
  pCoor pos1( 12, 10, 21.4 );
  card0->upper_left = pos0;
  card0->upper_right = pos0;
  card0->upper_right.x += 5;
  card0->lower_left = card0->upper_left + pVect(0,-5,0);
  card0->lower_right = card0->upper_right + pVect(0,-5,0);

  //*** added 11/13
  //attempt to rotate card 1 to be horizontal instead of vertical
  pVect card_to_ctr(card0->upper_left,pCoor(0,0,0));
  ...
  pMatrix_Translate trans_card_to_ctr(card_to_ctr);
   ...
   pVect ul_to_ur(card0->upper_left,card0->upper_right);
   pMatrix_Rotation rot_card_horizontal(ul_to_ur, 45);

   pMatrix rotateCard0 =  trans_card_to_pos * rot_card_horizontal * trans_card_to_ctr;
   card0->upper_left = rotateCard0 * card0->upper_left;
   card0->upper_right = rotateCard0 * card0->upper_right;
   card0->lower_left = rotateCard0 * card0->lower_left;
   card0->lower_right = rotateCard0 * card0->lower_right;
  */
 ...
 pVect card_to_ctr(card1->upper_left,pCoor(0,0,0));
   // Construct translation matrix to center.
  pMatrix_Translate trans_card_to_ctr(card_to_ctr);
   ...
   pVect ul_to_ur(card1->upper_left,card1->upper_right);
   pMatrix_Rotation rot_card_horizontal(ul_to_ur,90);

   pMatrix rotateCard0 =  trans_card_to_pos * rot_card_horizontal * trans_card_to_ctr;
   card1->upper_left = rotateCard0 * card1->upper_left;
   card1->upper_right = rotateCard0 * card1->upper_right;
   card1->lower_left = rotateCard0 * card1->lower_left;
   card1->lower_right = rotateCard0 * card1->lower_right;
